      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-slate-200">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-playfair-display text-slate-800">Why Join Shiksha ?</h2>
          </div>
            ...
            <div className="md:w-7/12 lg:w-1/2" data-aos="fade-up">
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  ...
                  <div>
                    <div className="text-slate-800 font-medium mb-1">Flexible Schedule</div>
                ...
                >
                  ...
                  <div>
                    <div className="text-slate-800 font-medium mb-1">Affordable Price
</div>
                    <div className="text-slate-500">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur velit.</div>
                  </div>
                </button>
                <button
                  className={`flex items-start text-left bg-white border-2 px-5 py-3 rounded shadow-md transition duration-300 ease-in-out mb-3 ${tab !== 4 ? 'border-transparent opacity-50 hover:opacity-75' : 'border-2 border-blue-500 opacity-100'}`}
                ...
                >
                  ...
                  <div>
                    <div className="text-slate-800 font-medium mb-1">Engaging Quizzes
</div>
                    <div className="text-slate-500">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur velit.</div>
                  </div>
                </button>
                <button
                  className={`flex items-start text-left bg-white border-2 px-5 py-3 rounded shadow-md transition duration-300 ease-in-out mb-3 ${tab !== 5 ? 'border-transparent opacity-50 hover:opacity-75' : 'border-2 border-blue-500 opacity-100'}`}
                ...
                >
                  ...
                  <div>
                    <div className="text-slate-800 font-medium mb-1">Certified Onstructors</div>
                    <div className="text-slate-500">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur velit.</div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    <div className="text-slate-800 font-medium mb-1">Peer Support
</div>
                    <div className="text-slate-500">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur velit.</div>
                  </div>
                </button>
